...
class SettingsTest(unittest.TestCase):
    def test_kws_defaults_to_shadow(self):
        ...
        self.assertEqual(settings.kws_preroll_seconds, 3.0)
        self.assertEqual(settings.kws_save_dir, "/opt/volc-stt-adapter/false_wakes")
        self.assertEqual(settings.kws_save_max_age_days, 30)
        self.assertEqual(settings.kws_save_max_size_mb, 500)
